...
export const DEFAULT_SKILL_ROUTING_POLICY: ResolvedSkillRoutingPolicy = {
  ...
  domains: {
    ui: {
      ...
      requiredSkills: ['frontend-design', 'ui-ux-pro-max'],
      recommendedSkills: ['awesome-design-md', 'webapp-testing', 'agent-browser', 'mcp-chrome-devtools', 'browser-testing-with-devtools', 'design-review'],
    ...
    desktopAutomation: {
      ...
      requiredSkills: ['cua'],
      recommendedSkills: ['agent-browser', 'web-access', 'computer-use', 'turix-cua', 'opencli'],
      requiredArtifacts: ['skill-plan.md', 'skill-evidence.md', 'verification.md'],
